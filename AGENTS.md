...
Pure skill plugin — no binary, no MCP server. Ships `skills/serena-wrapper/SKILL.md`, which Claude Code loads when the skill's `description` matches the user's intent.
